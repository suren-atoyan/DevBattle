...
const challenges = [
  'Challenge1', 'Challenge2', 'Challenge3', 'Challenge4', 'Challenge5', 'Challenge6', 'Challenge7', 'Challenge8', 'Challenge9', 'Challenge10',
];
  ...
  render(){
    ...
    return(
      <HighchartsChart>
        ...
        <Tooltip valueSuffix="quiz" shared />

        <XAxis categories={challenges}>
          <XAxis.Title>Challenges</XAxis.Title>
        </XAxis>
